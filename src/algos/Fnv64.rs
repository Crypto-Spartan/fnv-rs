...
impl Default for FnvHasher64 {
    ...
    fn default() -> FnvHasher64 {
        FnvHasher64(consts::FNV_OFFSET_64)
    }
}

impl FnvHasher for FnvHasher64 {
    #[inline]
    fn new() -> Self {
        FnvHasher64::default()
    }
    ...
    fn hash<T: AsRef<[u8]>>(bytes: T) -> FnvHashResult {
        let mut hash = consts::FNV_OFFSET_64;
